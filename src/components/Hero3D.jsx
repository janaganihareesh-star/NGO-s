    ...
    <section className="relative h-screen w-full bg-primary-navy overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-6">
        ...
        >
          ...
          >
            <div className={`w-2 h-2 rounded-full animate-pulse ${isDarkMode ? 'bg-primary-gold shadow-[0_0_10px_#C9933A]' : 'bg-gray-800 shadow-[0_0_10px_rgba(0,0,0,0.5)]'}`} />
          ...
          <h1 className={`text-6xl md:text-9xl font-heading font-black mb-6 leading-tight select-none ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
          ...
          <p className={`font-body text-xs md:text-sm tracking-[0.6em] uppercase mb-10 block font-bold ${isDarkMode ? 'text-primary-gold/80' : 'text-gray-700'}`}>
            Women • Children • LGBTQ • Elderly • Environment
          </p>

          <p className={`max-w-2xl mx-auto font-body text-lg mb-12 select-none ${isDarkMode ? 'text-primary-offwhite/60' : 'text-gray-600'}`}>
